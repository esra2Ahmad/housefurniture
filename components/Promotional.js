...
const Promotional = () => {
  return (
    <div className="w-full h-[764px] bg-lightviolet  inline-flex mt-20">
      <div>
      <Image
      ...
      <div className=" flex flex-col justify-center items-start  absolute  top-96 left-80">
        <p className="text-pink text-base font-bold leading-7">Best Furniture For Your Castle....</p>
        ...
        <p className="text-lightgray text-base font-bold leading-7">
          Lorem ipsum dolor sit amet, consectetur adipiscing <br/>elit. Magna in est
      ...
      <div className="  ">
      <div className="w-[651px] h-[651px] bg-lightpink bg-opacity-30 rounded-full absolute right-[43px] top-[219px]" />
      <div className="w-[648px] h-[648px] bg-lightpink bg-opacity-30 rounded-full absolute right-[80px] top-[260px]" />
            <Image
              src="/../images/Shell-Shaped-Armchair-Pink-Velvet-Fabric-One-Seater-Sofa-for-Living-Room 1.png"
              width={629}
              height={629}
              alt=""
              className="absolute right-[90px] top-[279px]"
            />
            <div className="w-[136.56px] h-[138.49px] absolute right-[85px] top-[174px] flex justify-center items-start">
        <svg
