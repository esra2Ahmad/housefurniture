...
const Promotional = () => {
  return (
    <div className="w-full h-[764px] bg-lightviolet relative  inline-flex mt-20">
      ...
      <div className="  ">
        <div className="w-[651px] h-[651px] bg-lightpink bg-opacity-30 rounded-full absolute right-[43px] top-[50px]" />
        <div className="w-[648px] h-[648px] bg-lightpink bg-opacity-30 rounded-full absolute right-[80px] top-[60px]" />
        <Image
