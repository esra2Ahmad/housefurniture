    ...
    <div className="mb-[74px] mt-[124px]">
      ...
      >
        <div className="w-full flex justify-between items-center ">
          <div>
            <h3 className="text-blue text-[22px] font-bold mb-2">
              Ecommerce Acceories & Fashion item{" "}
            </h3>
            <p className="text-lightpurple text-xs font-normal">
              About 9,620 results (0.62 seconds)
            </p>
          </div>
          <form className="flex justify-end items-center">
            <label className="text-blue7 text-base font-normal mr-2">
              Per Page:{" "}
            </label>
            <input
              className="w-[55px] h-[25px] border border-gray mr-6"
            />
            <label className="text-blue7 text-base font-normal mr-2">
              Sort By:{" "}
            </label>
            <select
              ...
              className="w-24 h-7 border border-gray text-lightpurplr text-xs font-normal leading-[18px] mr-6"
            >
            ...
            <input
              className="w-[162px] h-[30px] border border-gray"
              type="text"
              placeholder=""
