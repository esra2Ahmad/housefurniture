...
const TopCard = (props) => {
  return (
    <div className='w-[269px] h-[345px}  bg-neutral_100 duration-500 hover:w-[260px]  hover:h-[340px] hover:translate-x-1 relative flex-col justify-start items-center flex gap-[27px] group'>
